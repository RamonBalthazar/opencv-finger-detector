...
while True:
 ...
 if frame is not None:
  ...
  crop1,percLeft,numLeft = funcs.findHand(frame[0:2*h*handSpace, 0:w*handSpace])

  crop2,percRight,numRight = funcs.findHand(frame[0:2*h*handSpace, 2*w*handSpace:w])
  ...
  cv2.putText(frame,instrument,(225,350), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 1)
  cv2.putText(frame,key,(225,400), cv2.FONT_HERSHEY_SIMPLEX, 2, (255,255,255), 2)
