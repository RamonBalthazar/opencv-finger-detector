...
def vLine(img,percent):
 ...
 cv2.line(img,(int(k*percent*w),0),(int(k*percent*w),h),(0,255,0))
...
def hLine(img,percent):
 ...
 cv2.line(img,(0,int(k*percent*h)),(w,int(k*percent*h)),(0,255,0)) 
...
def drawKeyboard(img):
 ...
 for i in range(12):
  cv2.line(img,(0,int(i*h/12)),(int(0.1*w),int(i*h/12)),(0,0,0))
  cv2.line(img,(int(0.9*w),int(i*h/12)),(w,int(i*h/12)),(0,0,0))
